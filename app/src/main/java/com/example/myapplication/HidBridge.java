...
public class HidBridge {
     ...
     */
    public HidBridge(Context context, int productId, int vendorId, TextView textInfo) {
        _context = context;
    ...
    public boolean OpenDevice() {
        ...
        if (_usbDevice == null) {
            ...
            str += "\n I search for VendorId:" + Integer.toString(_vendorId) +" and ProductId:" + Integer.toString(_productId);
            _textInfo.setText(str);
            return false;
        }
        ...
        str += "Found the device";
        str += "\n" + "DeviceID: " + _usbDevice.getDeviceId() + "\n"
                + "DeviceName: " + _usbDevice.getDeviceName() + "\n"
                + "DeviceClass: " + _usbDevice.getDeviceClass() + " - "
                + "DeviceSubClass: " + _usbDevice.getDeviceSubclass() + "\n"
                + "VendorID: " + _usbDevice.getVendorId() + "\n"
                + "ProductID: " + _usbDevice.getProductId() + "\n";
       // _textInfo.setText(str);
        return true;
    }
                ...
                synchronized (_locker) {
                    try
                    {
                        ...
                        if (r >= 0) {
                            ...
                            _textInfo.setText(composeString(bytes));

                            Vibrator v = (Vibrator) _context.getSystemService(_context.VIBRATOR_SERVICE);
